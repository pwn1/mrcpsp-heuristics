...
class NonRenewableRepair:
    ...
    def repair_nonrenewable(self, project: Project, mode_assignments: list[int]) -> list[int]|str:
        ...
        Returns repaired mode-assignments is feasible solution is found, and a warning message
        ...
        return self.INFEASIBLE # Iteration cap has been hit
