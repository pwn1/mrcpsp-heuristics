...
# TODO: This section is currently broken by the refactoring process.
#  However, because it is an edge concern, it seems easier to leave it
#  broken, and re-integrate at the end, than to keep this working.
